# xdmod-data
As part of the [XDMoD Data Analytics Framework](https://open.xdmod.org/data-analytics-framework.html), this Python package provides API access to the data warehouse of a running instance of XDMoD.
